...
- [x] Rename left/right-side labeling to **"Side 1" / "Side 2"** for two-sided exercises (trunk rotations, bird dogs, etc.) — more natural since users don't think in strict left/right order. (P3)
